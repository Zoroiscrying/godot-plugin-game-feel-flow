...
static func hit_light() -> GFFCombo:
	...
	arr.append(_create_shake(0.3, 0.1))
	arr.append(_create_flash(Color.WHITE, 0.05))
	arr.append(_create_scale(Vector2(1.05, 1.05), 0.1))
	combo.effects = arr
	return combo
...
static func hit_heavy() -> GFFCombo:
	...
	var arr: Array[GFFFeedback] = []
	arr.append(_create_shake(0.6, 0.15))
	arr.append(_create_flash(Color.WHITE, 0.08))
	arr.append(_create_freeze(0.03))
	arr.append(_create_scale(Vector2(1.15, 1.15), 0.15))
	combo.effects = arr
	return combo
...
static func death() -> GFFCombo:
	...
	arr.append(_create_scale(Vector2(0.8, 0.8), 0.2))
...
static func explosion() -> GFFCombo:
	...
	var arr: Array[GFFFeedback] = []
	arr.append(_create_shake(1.5, 0.3))
